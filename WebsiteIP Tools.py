  ...
  ▒██ █░░▒▓█  ▄ ▓██▒  ▐▌██▒  ▄▀▒   ░
   ...
   ░ ░░   ░ ░  ░░ ░░   ░ ▒░░░▒ ▒ ░ ▒  
     ░░     ░      ░   ░ ░ ░ ░ ░ ░
      ░     ░  ░         ░   ░ ░    
     ░                     ░   by venz.db""")
    print(Fore.MAGENTA + "╔═══       Tools         ═══╗ ╔═══     My Socials      ═══╗ ╔═══     More Tools    ═══╗")
    print(Fore.MAGENTA + "║  {1} WebSite Ip & Port    ║ ║  {Discord} venz.db        ║ ║  {Github}               ║")
    print(Fore.MAGENTA + "║  {2} Exit                 ║ ║  {Github} VenzOT          ║ ║                         ║")
    print(Fore.MAGENTA + "║  {Hx Shop}  .gg/HxShop    ║ ║  {TikTok} .venzot         ║ ║                         ║")
    print(Fore.MAGENTA + "║  {HxH Serv} .gg/hxh       ║ ║  {Serv Commu} .gg/commufr ║ ║                         ║")
    print(Fore.MAGENTA + "╚═══                     ═══╝ ╚═══                     ═══╝ ╚═══                   ═══╝")
